...
function DoencasNaoTransmissiveis() {
    function abrirPesquisa() {
        const url = "https://www.google.com/search?q=Como+se+conscientizar+sobre+doenças+não+transmissíveis";
        ...
        <div>
            ...
            <section className="call-to-action bg-warning py-5 text-center">
                <div className="container">
                    ...
                    <button className="btn btn-lg btn-secondary" onClick={abrirPesquisa}>Engaje-se</button>
                </div>
            </section>
